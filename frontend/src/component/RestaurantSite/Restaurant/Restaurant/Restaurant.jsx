          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 ">
            ...
            <div className="space-y-3 lg:space-x-6">
              ...
              <div className=" grid grid-cols-2 lg:grid-cols-3 gap-2">
                <img
                  src="http://wahabali.com/work/pearl-demo/images/instagram-img1.jpg"
                  alt="food"
                />
                <img
                  src="http://wahabali.com/work/pearl-demo/images/instagram-img3.jpg"
                  alt="food"
                />
                <img
                  src="http://wahabali.com/work/pearl-demo/images/instagram-img6.jpg"
                  alt="food"
                />
                <img
                  src="http://wahabali.com/work/pearl-demo/images/instagram-img5.jpg"
                  alt="food"
                />
                <img
                  src="http://wahabali.com/work/pearl-demo/images/instagram-img4.jpg"
                  alt="food"
                />
                <img
                  src="http://wahabali.com/work/pearl-demo/images/instagram-img2.jpg"
                  alt="food"
                />
              </div>
            </div>
